document.getElementById('formCostos').addEventListener('submit', function(e) {
    ...
    // Envia los datos al archivo PHP para que realice los cálculos
    fetch('main.php', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json()) // El PHP devuelve los resultados en formato JSON
    .then(data => {
        // Selecciona el div donde se mostrarán los resultados
        const resultadoDiv = document.getElementById('resultado');
        
        // Muestra los resultados de los cálculos en el HTML
        resultadoDiv.innerHTML = `
            ...
            <h4>Cédula 5 (Valuacion de la Prod Terminada):</h4>
            <p>Valuacion de la producción Terminada: $${data['Val.Prod Termi']}</p>

            <h4>Cédula 6 (Valuación de Inventario Final):</h4>
